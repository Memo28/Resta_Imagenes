...
class PhotoCtrl(wx.App):
    ...
    def __init__(self, redirect=False, filename=None, *args, **kwargs):
        ...
        self.frame = wx.Frame(None, title='Medical System',size=(3000,3000))       
...
#--------------------------------------------------------------------------       
    def createWidgets(self):
        ...
        label_ri = wx.StaticText(self.panel,label="Location",size=(200,20),style=wx.ALIGN_CENTER)
        #Boton 1
        browseBtn = wx.Button(self.panel, label='Open First Radiography',size=(200,30),pos=(0,700))
        browseBtn.Bind(wx.EVT_BUTTON, self.onBrowse)
        #Boton 2
        browseBtn_2 = wx.Button(self.panel, label='Open Second Radiography',size=(200,30))
        browseBtn_2.Bind(wx.EVT_BUTTON, self.onBrowse)
        #Boton de rotar Primera Imagen 90 Derecha
        label_rot = wx.StaticText(self.panel,label="Rotations",size=(200,20),style=wx.ALIGN_CENTER)
        browseBtn_Rd_1 = wx.Button(self.panel, label='Rotate +90 First Image',size=(200,30))
        browseBtn_Rd_1.Bind(wx.EVT_BUTTON, self.onRotate_90R)
        #Boton de rotar Primera Imagen 90 Izquierda
        browseBtn_Ri_1 = wx.Button(self.panel, label='Rotate -90 First Image ',size=(200,30))
        browseBtn_Ri_1.Bind(wx.EVT_BUTTON, self.onRotate_90L)
        #Boton de Rotar Segunda Imagen 90 Derecha
        browseBtn_Rd_2 = wx.Button(self.panel, label='Rotate +90 Second Image ',size=(200,30))
        browseBtn_Rd_2.Bind(wx.EVT_BUTTON, self.onRotate_90R)
        #Boton de Rotar Segunda Imagen 90 Izquierda
        browseBtn_Ri_2 = wx.Button(self.panel, label='Rotate -90 Second Image ',size=(200,30))
        browseBtn_Ri_2.Bind(wx.EVT_BUTTON, self.onRotate_90L)
        #Rotacion Libre Imagen 1
        browseBtn_rlibre_1=wx.Button(self.panel,label="Free Rotation First Image ",size=(200,30))
        browseBtn_rlibre_1.Bind(wx.EVT_BUTTON, self.onFreeRo)
        #Rotacion Libre Imagen 2
        browseBtn_rlibre_2=wx.Button(self.panel,label="Free Rotation Second Image",size=(200,30))
        browseBtn_rlibre_2.Bind(wx.EVT_BUTTON, self.onFreeRo)
        #Ajuste de Imagen
        label_ajustar = wx.StaticText(self.panel,label="Fit Image",size=(200,30),style=wx.ALIGN_CENTER)
        browseBtn_ajImg_1=wx.Button(self.panel,label="First Image",size=(200,30))
        browseBtn_ajImg_1.Bind(wx.EVT_BUTTON, self.onCrop)

        browseBtn_ajImg_2=wx.Button(self.panel,label="Second Image",size=(200,30))
        browseBtn_ajImg_2.Bind(wx.EVT_BUTTON, self.onCrop)
        #Etiqueta Histograma
        label_histogram = wx.StaticText(self.panel,label="Histogram",size=(200,20),style=wx.ALIGN_CENTER)
        #Generar Hiograma A-B
        browseBtn_Histo = wx.Button(self.panel, label='Generate Histogram A-B',size=(200,30))
        browseBtn_Histo.Bind(wx.EVT_BUTTON, self.onHistograma)
        #Generar Hiograma B-A
        browseBtn_Histo_2 = wx.Button(self.panel, label='Generate Histogram B-A',size=(200,30))
...
#------------------------------------------------------------------------
    ...
    def onView(self,id_i):
        ...
        if W < H :
            ...
            NewW = self.PhotoMaxSize * W / H
        img = img.Scale(600,600)
        if(id_i=="Open First Radiography"):
...
class NewWindow(wx.Frame):
    ...
    def __init__(self,parent,id,g_osea,inicial,resultante):
        ...
        txt1 = "Gain bone density = "+str(g_osea)+"\n"
        txt2= "Average value of the gray scale of the result image = " + str(resultante)+"\n"
        txt3 = "Average value of the gray scale of the first image  = "+ str(inicial) 
        txt = txt1 + txt2 + txt3 
...
class MyWindowsInfo(wx.Frame):
    ...
    def __init__(self):
        wx.Frame.__init__(self, None, -1, "Medical System", size=(300, 250))
        self.panel = wx.Panel(self,-1)
        wx.StaticText(self.panel, -1, "Medical System for X-ray Analysis", pos=(60, 12))
        ...
        button=wx.Button(self.panel,label="NEXT",pos=(90, 150), size = (100,50))
